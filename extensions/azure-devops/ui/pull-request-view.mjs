...
export function renderPullRequest(container, pr, options) {
    ...
    headerCopy.append(merge);
    header.append(headerCopy);
    // The decisions on the pull request sit on the title's row, at the right,
    // where the Azure DevOps web UI puts them. The edit pencil moves in beside
    // them rather than staying next to the title, so the whole right-hand side of
    // the header is "things you can do".
