...
// HTML, 2,244 tag occurrences in total, nearly all of it from the GitOps and
// Agency bots. That markup has to keep rendering, which is why the renderer
...
export const TYPE_PARAMETERS = [
    {
        id: "di-registration",
        source: "Register it with serviceCollection.AddSingleton<AgencySigningKeyProvider>(); first.",
        text: ["AddSingleton<AgencySigningKeyProvider>"],
    },
    {
        id: "nested-generic",
        source: "Resolve it through sp.GetRequiredService<ILogger<AgencySigningKeyProvider>>() instead.",
        text: ["GetRequiredService<ILogger<AgencySigningKeyProvider>>"],
    },
    {
        id: "options-monitor",
        source: "Use sp.GetRequiredService<IOptionsMonitor<AgencyTokenSettings>>() so reloads are picked up.",
        text: ["IOptionsMonitor<AgencyTokenSettings>"],
    },
    {
        id: "rust-vec",
...
export const BOT_MARKUP = [
    ...
    {
        id: "deployment-table",
        source: "<table><tr><td>App</td><td><strong>AgencyInfra</strong></td></tr></table>",
    ...
    },
    {
        ...
        source: [
            "<table>",
            "<tr>",
            "<td><strong>AgencyInfra</strong></td>",
            "</tr>",
            "</table>",
        ].join("\n"),
        markup: ["table", "tr", "td", "strong"],
